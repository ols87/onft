...
contract UniversalONFT721 is ONFT721 {
  ...
  constructor(string memory _name, string memory _symbol, uint _minGasToTransfer, address _layerZeroEndpoint, uint _startMintId, uint _endMintId) ONFT721(_name, _symbol, _minGasToTransfer, _layerZeroEndpoint) {
