...
import type {
  ONFT721Core,
  ONFT721CoreInterface,
} from "../../contracts/ONFT721Core";
...
export class ONFT721Core__factory {
  static readonly abi = _abi;
  static createInterface(): ONFT721CoreInterface {
    return new utils.Interface(_abi) as ONFT721CoreInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ONFT721Core {
    return new Contract(address, _abi, signerOrProvider) as ONFT721Core;
  }
}
